...
const Data = () => {
    return ( 
        <div className='home__data'>
            <h1 className="home__title">Udeme John
            ...
            <p className='home__description'>I'm creative designer based in Plateau State, and I'm very passionate and dedicated to my work.</p>
